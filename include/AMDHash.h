...
__device__ bool getHash160_33_from_limbs_matches(uint8_t prefix02_03, const uint64_t x_be_limbs[4], const uint8_t target_hash160[20], uint32_t target_prefix_le, uint32_t h160_out[5] = nullptr);
#endif // AMD_HASH_H
